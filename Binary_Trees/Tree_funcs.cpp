...
void Create_new_node(Node** node, const void* data, size_t data_size) {
...
void Insert_node(Node* node, const void* data, size_t data_size,
                 Node** (*Compare_func) (Node* root, const void* search_data, size_t search_data_size)) {
...
void Replace_node(Node** initial_node, const void* replacing_value, const void* new_node_value, size_t values_size,
                  Node** (*Compare_func) (Node* root, const void* search_data, size_t search_data_size)) {
    ...
    if((*initial_node)->left_node == NULL && (*initial_node)->right_node == NULL){
        ...
        Node** replacing_node = Compare_func(*initial_node, &initial_node_copy->node_data, values_size);
...
void Replace_node_auto(Node** initial_node, const void* searching_value, const void* replacing_value,
                       const void* new_node_value, size_t values_size,
                       Node** (*Compare_func) (Node* root, const void* search_data, size_t search_data_size)) {
